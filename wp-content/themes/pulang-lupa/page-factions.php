...
$fx_chapters = [
    ...
    [
        ...
        'rules' => [
            [
                'id' => 'territory-influence', 'num' => 11, 'title' => 'Areas of Influence System',
                'blocks' => [
                    ['p', "Factions may establish an Area of Influence through continued and meaningful In-Character presence within a particular location. An Area of Influence represents a faction's established presence, activities, and relationships within an area and does not automatically constitute ownership or unrestricted authority over the location."],
                    ['h', 'Illegal Operations'],
                    ['p', "Criminal factions, gangs, bandit groups, cults, and other illegal organizations may establish areas where they conduct their operations. These areas represent criminal presence and influence rather than legal ownership or governmental authority."],
                    ['p', "Other players and factions may still enter, pass through, conduct business, or roleplay within these areas."],
                    ['note', "Factions may not use their Area of Influence as automatic justification to threaten, attack, or remove others. Any conflict arising from another party entering or interfering with the area must be established through proper In-Character RP."],
                    ['h', 'Government Operations'],
                    ['p', "Recognized governments may exercise authority throughout their designated state or jurisdiction. Government authority is based on the recognized boundaries of the state rather than a limited Area of Influence."],
                    ['p', "Government factions may regulate public spaces, businesses, law enforcement, and other state affairs within their jurisdiction, provided such actions remain within the server rules and established lore."],
                    ['h', 'Political & Revolutionary Movements'],
                    ['p', "Political parties, revolutionary movements, military juntas, separatist groups, and other organizations seeking to alter, replace, or separate themselves from an established government may establish areas of influence through legitimate In-Character RP."],
                    ['p', "These groups do not automatically gain governmental authority simply by declaring independence, occupying an area, or claiming political control. Any attempt to overthrow a government, establish a new state, seize governmental authority, or separate territory from an established state must develop through proper RP and may be subject to Management review."],
                    ['note', "Political authority and territorial control must be established through RP and the appropriate administrative process. A faction may not unilaterally declare itself the recognized government or authority of a territory."],
                    ['h', 'State Expansion & Area of Influence Takeovers'],
                    ['p', "Changes in territorial control may occur through legitimate In-Character roleplay. The method and requirements for a takeover depend on the parties involved and the nature of the territory being contested. Territorial control cannot be established solely through declaration and must be supported by meaningful RP and, where applicable, Management recognition."],
                    ['sub', '1. Government → Government: State Expansion & Annexation', "A recognized government may seek to expand its territory or annex land currently administered by another recognized government. Such actions must develop through proper political, diplomatic, or military RP. A government may not simply declare another state's territory as its own without a legitimate IC development. Any successful annexation or permanent change in state borders must be reviewed and recognized by Management before becoming an official change to the server's political map."],
                    ['sub', '2. Government → Criminal Faction: Reclaiming Territory', "A recognized government may attempt to reclaim an area that has come under the control or influence of a criminal faction, such as a gang, bandit group, or organized criminal organization. Government forces may conduct operations against these groups when supported by legitimate IC circumstances. Criminal control of an area does not prevent a government from enforcing its laws within its recognized jurisdiction. All such operations must still follow the applicable conflict, escalation, and PvP rules."],
                    ['sub', '3. Faction → Faction: Area of Influence Takeover', "A faction may attempt to take over or establish control over an Area of Influence currently occupied by another faction. A takeover must develop through meaningful RP and cannot be established simply by entering an area, defeating another faction in a single encounter, or declaring ownership. Takeovers may develop through negotiation, intimidation, economic competition, political maneuvering, or armed conflict. If the situation escalates into faction warfare, the applicable faction warfare rules must be followed."],
                    ['sub', '4. Revolutionary Movement → Government: Coup, Revolution & Territorial Seizure', "A revolutionary movement, military junta, political organization, or other faction may attempt to overthrow or replace an established government through legitimate In-Character RP. This may include coups, revolutions, military occupations, political uprisings, or attempts to seize government institutions and territory. These are considered major political events and must be properly developed through RP. A faction cannot simply declare that a coup has succeeded or that it now controls a state. Management may review the situation and recognize the outcome based on the RP and actions of the involved parties."],
                    ['sub', '5. Separatist Movement → State: Secession & Establishment of a New State', "A separatist or independence movement may attempt to separate a territory from an established state and establish itself as an independent political entity. Such movements may develop through political campaigns, civil unrest, negotiations, rebellion, military action, or other appropriate forms of RP. Declaring independence does not automatically create a new state. The movement must establish meaningful control and develop the necessary political circumstances through RP before the separation can be recognized. Any permanent change to state borders or the creation of a new recognized state requires Management review and approval."],
                    ['h', 'Territorial Expansion & Takeover Cooldown'],
                    ['note', "A 21 OOC day cooldown applies to all territorial expansion and Area of Influence takeover attempts."],
                    ['list', "The cooldown works as follows:", 'neutral', [
                        "A state or faction must wait 21 OOC days before attempting to annex another state or establish a new Area of Influence following a successful expansion or takeover.",
                        "A state or faction that has recently had its territory or Area of Influence attacked, taken over, or annexed must be given 21 OOC days before another state or faction may initiate a new attempt to attack, annex, or take over that same territory.",
                        "The 21-day cooldown applies to everyone, regardless of the faction, government, or political movement involved.",
                        "The cooldown applies specifically to new attempts to change or seize territorial control and does not prevent ordinary RP, political opposition, law enforcement activity, or other interactions within the territory.",
                    ]],
                    ['p', "The purpose of this cooldown is to allow territorial changes to develop into meaningful RP rather than allowing territories to continuously change hands through back-to-back conflicts."],
                ],
            ],
            [
