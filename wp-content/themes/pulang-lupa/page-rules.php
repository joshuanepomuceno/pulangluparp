        ...
        'rules'    => [
            ...
            [
                ...
                'blocks' => [
                    ...
                    ['h', 'Equal Force Rule'],
                    ['p', 'Players are expected to respond to combat with a level of force appropriate to what was initially used against them. The escalation of force should remain consistent with the circumstances of the encounter.'],
                    ['p', 'For example, if a player initiates a fistfight, the opposing player should respond with melee combat rather than immediately using a firearm. If firearms are drawn and used, the other player may respond with a firearm of a comparable level of force.'],
                    ['h', 'Kill on Sight (KOS)'],
            ...
            [
                ...
                'blocks' => [
                    ...
                    ['list', 'Guidelines:', 'neutral', [
                        'Factions who decide to visit towns for roleplay purposes are allowed to have a maximum of 15 people. This is in consideration of RedM\'s limitation on entities within an area.',
        ...
        'rules'    => [
            ...
            [
                ...
                'blocks' => [
                    ...
                    ['p', 'However, for extensive immersion, Bad Cop RPs such as corruption and bribery are allowed.'],
                ],
            ],
            [
