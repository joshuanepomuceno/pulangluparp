            ...
            [
                ...
                'blocks' => [
                    ...
                    ['list', 'Players are reminded that these are also not allowed:', 'mustnot', [
                        ...
                        'Deliberate Rule-Breaking — knowingly violating a rule for the purpose of testing, challenging, or determining the limits of the Administration\'s enforcement or verdicts. If it is established that a player deliberately committed an infraction despite knowing it was prohibited, the intent to "test" the Administration may be considered an aggravating circumstance and may result in a more severe sanction, with finality determined by the Administration.',
                    ]],
                ],
            ],
            [
